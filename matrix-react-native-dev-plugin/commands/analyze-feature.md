...
4. Populate `templates/feature-analysis-template.md` in full: the feature request, `repo-analyst`'s findings verbatim, `rn-architect`'s proposed approach, and any open questions/risks. Leave `status: proposed` in the frontmatter — do not mark it `approved`.
